...
_G.packer_plugins = {
  ...
  ["nvim-tree.lua"] = {
    config = { "require('config.nvimtreeconfig'), require('nvim-tree/nvim-web-devicons')" },
    loaded = true,
  ...
  ["vim-airline"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/vim-airline",
  ...
  ["vim-airline-themes"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/vim-airline-themes",
  ...
  ["vim-highlighturl"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/vim-highlighturl",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-highlighturl', 'bufferline.nvim', 'which-key.nvim', 'alpha-nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
